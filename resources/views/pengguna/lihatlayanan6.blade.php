            ...
            <div class="row">
                <div class="col-lg-12 course_details_left">
                    ...
                    <div class="content_wrapper">
                        <center><h4 class="title3">VI. PENGELOLAAN PENGADUAN</h4></center>
                            ...
                            <ul class="course_list" >
                              <div class="justify-content-between d-flex">
                                  <p style="color: #f8b600;">1.</p>
                                    ...
                                    <li>
                                      <a class="primary-btnz"  target="_blank" style="font-size: 13px;"  href="{{url('file/lampiran 2-25.png')}}">Tahapan</a>
                                    </li>
                                </div>
                                <br>
