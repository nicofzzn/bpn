...
<head>
  ...
  <link href="{{url('b/vendor/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css')}}"
    rel="stylesheet">
  <!-- Pick date -->
...
<body>
    ...
    <div class="quixnav">
      <div class="quixnav-scroll">
        <ul class="metismenu" id="menu">
          ...
          <li><a href="/logout" aria-expanded="false"><i class="ti-power-off"></i><span
  ...
  <!-- Material color picker -->
  <script src="{{url('b/vendor/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js')}}">
  </script>
  <!-- pickdate -->
